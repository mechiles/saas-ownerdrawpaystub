...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div>
            ...
            <p>YTD Net Pay: ${{ number_format($ytdNetPay, 2) }}</p>
        </div>
    </div>
            ...
            @if ($prevPayStubs)
                @foreach($prevPayStubs as $draw)
                    <tr>
                        ...
                        <td class="border px-4 py-2 w-1/3 rounded">{{ $draw->prevpayday }}</td>
                        <td class="border px-4 py-2 w-1/3 rounded">${{ number_format($draw->ownerdrawamount, 2) }}</td>
                    </tr>
                @endforeach
            @endif
            <tr>
